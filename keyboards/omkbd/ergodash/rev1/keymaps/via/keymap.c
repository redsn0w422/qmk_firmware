...
// VIA owns the keymap at runtime, so this is plain keycode data only:
// no custom keycodes, no process_record_user, no tri-layer logic.
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

  /* Layer 0: QWERTY base (from the default keymap, thumbs use MO() for VIA) */
  [0] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             MO(1),   KC_SPC,  KC_DEL,      KC_BSPC, KC_ENT,  MO(2),            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
